<template lang="pug">
//- .fullscreen-btn(@click="toggleScreen")
.fullscreen(@click="toggleScreen" title="地图全屏")
    svg(viewBox="0 0 1024 1024" v-if="!full")
...
export default {
    ...
    methods: {
        toggleScreen: function () {
            let map = document.getElementById('mapv');
            if (this.full) {
                map.style.left = '220px';
                map.style.zIndex = 0;
            } else {
                map.style.left = 0;
                map.style.zIndex = 3000;
            }
            this.full = !this.full;
        }
    },
